...
const Employees = () => {
  ...
  const getBadgeClass = (department) => {
    switch (department) {
      case 'Design': return styles.designBadge;
      case 'Development': return styles.developmentBadge;
      case 'HR': return styles.hrBadge;
      case 'PM': return styles.pmBadge;
      case 'Business': return styles.businessBadge;
      default: return '';
    }
  };
  ...
  const renderPaginationButtons = () => {
    ...
    for (let i = 1; i <= totalPages; i++) {
      buttons.push(
        <button 
          key={i} 
          className={`${styles.paginationButton} ${currentPage === i ? styles.activePaginationButton : ''}`}
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          <div>
            <div className={styles.headerTitle}>Employee (Manage your Employees)</div>
